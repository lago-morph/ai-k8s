...
class TestAWSClientProperties:
    ...
    @patch("mk8.integrations.aws_client.boto3")
    def test_property_validation_result_has_suggestions_on_failure(self, mock_boto3: Mock) -> None:
    ...
    @patch("mk8.integrations.aws_client.boto3")
    def test_property_successful_validation_has_account_id(self, mock_boto3: Mock) -> None:
    ...
    @patch("mk8.integrations.aws_client.boto3")
    def test_property_failed_validation_has_error_details(self, mock_boto3: Mock) -> None:
